...
import StiResultsManagement from './pages/dashboard/Consultant/components/StiResultManagementPage';
      ...
      <AutoConfirmNotification />
        ...
        <Routes>
          ...
          <Route path="/staff/*" element={<StaffDashboard />}>
            ...
            <Route path="orders" element={<OrdersManagement refreshTrigger={refreshTrigger} />} />
