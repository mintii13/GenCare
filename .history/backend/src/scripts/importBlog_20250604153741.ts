...
async function insertBlogData() {
    try {
        ...
        const usersData = [
            {
                ...
                status: true,
                email_verified: true,
                registration_date: new Date("2024-01-15T08:00:00.000Z"),
                updated_date: new Date("2024-12-01T10:30:00.000Z")
            },
            {
                ...
                status: true,
                email_verified: true,
                registration_date: new Date("2024-02-20T09:15:00.000Z"),
                updated_date: new Date("2024-11-28T14:00:00.000Z")
            },
            {
                ...
                status: true,
                email_verified: true,
                registration_date: new Date("2024-06-10T14:30:00.000Z"),
                updated_date: new Date("2024-12-02T15:00:00.000Z")
            },
            {
                ...
                status: true,
                email_verified: true,
                registration_date: new Date("2024-07-05T10:20:00.000Z"),
                updated_date: new Date("2024-12-02T16:00:00.000Z")
            }
        ];
        ...
        // Lấy ObjectId của users để làm reference
        ...
        // Insert Consultants (không có consultant_avatar nữa)
        const consultantsData = [
            {
                consultant_id: "1",
                user_id: lanUser._id.toString(),
        ...
        // Insert Customers (không có custom_avatar nữa)
        const customersData = [
            {
                customer_id: "1",
                user_id: hoaUser._id.toString(),
                medical_history: "Không có bệnh lý đặc biệt",
                last_updated: new Date("2024-11-15T14:20:00.000Z")
            },
            {
                customer_id: "2",
                user_id: maiUser._id.toString(),
        ...
        // Insert Blogs (author_id là ObjectId)
        const blogsData = [
            {
                blog_id: 1,
                author_id: lanUser._id, // ObjectId
            ...
            {
                blog_id: 2,
                author_id: minhUser._id, // ObjectId
        ...
        // Insert Blog Comments (customer_id là ObjectId)
        const commentsData = [
            {
                comment_id: 101,
                blog_id: 1,
                customer_id: hoaUser._id, // ObjectId
            ...
            },
            {
                comment_id: 102,
                blog_id: 1,
                customer_id: maiUser._id, // ObjectId
