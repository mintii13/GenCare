...
export class ConsultantScheduleRepository {
    public static async findByConsultantId(
        ...
        try {
            ...
            // Nếu có startDate hoặc endDate, tạo điều kiện ngày
            if (startDate || endDate) {
                ...
                if (startDate) {
                    ...
                    dateQuery.$gte = start;
                    console.log('Start date filter:', start); // Debug log
                }
                ...
                if (endDate) {
                    ...
                    dateQuery.$lte = end;
                    console.log('End date filter:', end); // Debug log
                }
            ...
            const results = await ConsultantSchedule.find(query)
                .sort({ date: 1 })
                .lean();
    ...
    public static async updateById(
        ...
        try {
            // Loại bỏ các field undefined trước khi update
            ...
            return await ConsultantSchedule.findByIdAndUpdate(
                scheduleId,
                { ...cleanUpdateData, updated_date: new Date() },
