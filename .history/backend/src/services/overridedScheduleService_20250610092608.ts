...
export class OverridedScheduleService {
    ...
    public static async createOverride(
        ...
        try {
            ...
            const activeSchedule = await WeeklyScheduleRepository.findByConsultantId(
    ...
    public static async getDaySchedule(
        ...
        try {
            ...
            if (override) {
                ...
                if (override.override_type === 'custom_hours' && override.custom_start_time && override.custom_end_time) {
                    const slots = this.generateTimeSlots(
                        ...
                        override.custom_break_start,
                        override.custom_break_end
                    );
            ...
            const workingDay = activeSchedule.working_days[dayOfWeek as keyof typeof activeSchedule.working_days];
    ...
    /**
     * Tạo danh sách các time slot từ thời gian làm việc - FIXED VERSION với break_start/break_end
     */
